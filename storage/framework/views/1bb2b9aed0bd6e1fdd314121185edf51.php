...
<?php echo e(html()->form('POST', route('admin.' . request()->segment(2) . '.store'))->attribute('enctype', 'multipart/form-data')->id('store')->open()); ?>
    ...
    <div class="row">
        <div class="col-md-8 col-sm-12">
            ...
            <div class="mt-4 form-group">
                <?php echo e(html()->button('Save Client Details')->type('button')->class('btn btn-success bg-gradient')->attribute('onclick = store(this)')); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\asifj\Documents\enabledtalent\resources\views/admin/companies/create.blade.php ENDPATH**/ ?>