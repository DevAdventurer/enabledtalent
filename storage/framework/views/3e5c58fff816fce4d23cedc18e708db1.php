                    ...
                    <table id="dataTableAjax" class="display table-sm border-secondary dataTableAjax table table-striped table-bordered dom-jQuery-events" >
                        <thead>
                            <tr>
                                ...
                                <th>Name</th>
                                <th>Snippet Name</th>
                                <?php if (\Illuminate\Support\Facades\Blade::check('can', ['edit_section','delete_section'])): ?>
                                <th>Action</th>
                                <?php endif; ?>
            ...
            { "data": "snippet_name" }, 
            {
                ...
                render: function(data, type, row) {
                    if (type === 'display') {
                        ...
                        <?php if (\Illuminate\Support\Facades\Blade::check('can', 'edit_section')): ?>
                        ...
                        <?php if (\Illuminate\Support\Facades\Blade::check('can', 'delete_section')): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/asifjamal/Documents/enabledtalent/resources/views/admin/section/list.blade.php ENDPATH**/ ?>