    ...
    <div data-repeater-list="kt_docs_repeater_advanced">
        ...
        <div data-repeater-item class="repeater-row row-<?php echo e($index); ?>">
            <div class="custom-row gap-3 stock-error d-flex justify-content-between flex-sm-wrape">
                <div class="w-25 form-group<?php echo e($errors->has("kt_docs_repeater_advanced.$index.logo") ? ' has-error' : ''); ?>">
                ...
                <div class="w-100 form-group<?php echo e($errors->has("kt_docs_repeater_advanced.$index.link") ? ' has-error' : ''); ?>">
...
<?php /**PATH /Users/asifjamal/Documents/enabledtalent/resources/views/admin/section-snippets/logo-slider.blade.php ENDPATH**/ ?>