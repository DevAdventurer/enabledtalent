...
<div id="section_<?php echo e($section->id); ?>" class="video-with-text-section">
	<div class="container">
	<div class="video-text-row py-80">
		...
		<div class="video-text-video-section">
			<div class="poster-image">
				<?php if(isset($content['title'])): ?>
					<img src="<?php echo e(asset($content['thumbnail_image'])); ?>">
				<?php endif; ?>
				<img src="<?php echo e(asset('assets/img/hero/video-controls-2.svg')); ?>" class="google-meeting">
			</div>
				<a onclick="openPopup('<?php echo e($content['youtube_id']); ?>')" href="javascript:voide(0)" class="play-button" 
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/mamoonnasar/Documents/enabledtalent/resources/views/common/snippets/youtube-video.blade.php ENDPATH**/ ?>