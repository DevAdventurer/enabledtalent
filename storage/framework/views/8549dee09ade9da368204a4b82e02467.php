...
<div class="row">
    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
        <div class="card-grid-2 hover-up">
            <div class="card-grid-2-image-left"><span class="flash"></span>
                <div class="image-box"><img src="https://jobbox-html-frontend.vercel.app/assets/imgs/brands/brand-1.png" alt="jobBox"></div>
            ...
            <div class="card-block-info">
                ...
                <div class="mt-1"><span class="card-briefcase">Fulltime</span><span class="card-time">4<span> minutes ago</span></span>
                </div>
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
        <div class="card-grid-2 hover-up">
            <div class="card-grid-2-image-left"><span class="flash"></span>
                <div class="image-box"><img src="https://jobbox-html-frontend.vercel.app/assets/imgs/brands/brand-2.png" alt="jobBox"></div>
            ...
            <div class="card-block-info">
                ...
                <div class="mt-1"><span class="card-briefcase">Part time</span><span class="card-time">5<span> minutes ago</span></span>
                </div>
                <p class="font-sm color-text-paragraph mt-15">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae architecto eveniet, dolor quo repellendus pariatur.</p>
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
        <div class="card-grid-2 hover-up">
            <div class="card-grid-2-image-left"><span class="flash"></span>
                <div class="image-box"><img src="https://jobbox-html-frontend.vercel.app/assets/imgs/brands/brand-3.png" alt="jobBox"></div>
            ...
            <div class="card-block-info">
                ...
                <div class="mt-1"><span class="card-briefcase">Full time</span><span class="card-time">6<span> minutes ago</span></span>
                </div>
                <p class="font-sm color-text-paragraph mt-15">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae architecto eveniet, dolor quo repellendus pariatur.</p>
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
        <div class="card-grid-2 hover-up">
            <div class="card-grid-2-image-left"><span class="flash"></span>
                <div class="image-box"><img src="https://jobbox-html-frontend.vercel.app/assets/imgs/brands/brand-4.png" alt="jobBox"></div>
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
        <div class="card-grid-2 hover-up">
            <div class="card-grid-2-image-left"><span class="flash"></span>
                <div class="image-box"><img src="https://jobbox-html-frontend.vercel.app/assets/imgs/brands/brand-5.png" alt="jobBox"></div>
                <div class="right-info"><a class="name-job" href="company-details.html">Linkedin</a><span class="location-small">New York, US</span></div>
            </div>
            <div class="card-block-info">
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
        <div class="card-grid-2 hover-up">
            <div class="card-grid-2-image-left"><span class="flash"></span>
                <div class="image-box"><img src="https://jobbox-html-frontend.vercel.app/assets/imgs/brands/brand-6.png" alt="jobBox"></div>
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
        <div class="card-grid-2 hover-up">
            <div class="card-grid-2-image-left"><span class="flash"></span>
                <div class="image-box"><img src="https://jobbox-html-frontend.vercel.app/assets/imgs/brands/brand-7.png" alt="jobBox"></div>
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
        <div class="card-grid-2 hover-up">
            <div class="card-grid-2-image-left"><span class="flash"></span>
                <div class="image-box"><img src="https://jobbox-html-frontend.vercel.app/assets/imgs/brands/brand-8.png" alt="jobBox"></div>
...
<?php /**PATH /Users/mamoonnasar/Documents/enabledtalent/resources/views/common/snippets/featured-job.blade.php ENDPATH**/ ?>