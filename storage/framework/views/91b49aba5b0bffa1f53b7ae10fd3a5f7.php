            ...
            <div class="col-lg-9">
                <div class="user-profile-wrapper">
                   <div class="user-profile-card">
                    <?php echo e(html()->form('PUT', route('company.jobs.update', $job->id))->attribute('enctype', 'multipart/form-data')->id('storeForm')->open()); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group<?php echo e($errors->has('title') ? ' has-error' : ''); ?>">
                                ...
                                <?php echo e(html()->text('title', $job->title)->class('form-control')->placeholder('Enter Job Title')); ?>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group <?php echo e($errors->has('category') ? ' has-error' : ''); ?>">
                                ...
                                <?php echo e(html()->select('category', App\Models\JobCategory::orderBy('name', 'asc')->pluck('name', 'id'), $job->job_category_id)->class(' select')->placeholder('Choose Job Category')); ?>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group <?php echo e($errors->has('job_type') ? ' has-error' : ''); ?>">
                                ...
                                <?php echo e(html()->select('job_type', App\Models\JobType::orderBy('name', 'asc')->pluck('name', 'id'), $job->job_type_id)->placeholder('Choose Job Type')->class('select')); ?>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group <?php echo e($errors->has('experience') ? ' has-error' : ''); ?>">
                                ...
                                <?php echo e(html()->select('experience', App\Models\Experience::orderBy('name', 'asc')->pluck('name', 'id'), $job->experience_id)->placeholder('Choose Experience')->class('select')); ?>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group <?php echo e($errors->has('qualification') ? ' has-error' : ''); ?>">
                                ...
                                <?php echo e(html()->select(
                                    'qualification[]', 
                                    App\Models\Qualification::whereIn('id', $job->qualifications->pluck('id'))->pluck('name', 'id'), 
                                    $job->qualifications->pluck('id')->toArray()
                                )->id('qualification')->class('form-control')->multiple()); ?>
                        ...
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group <?php echo e($errors->has('offer_salary_min') ? ' has-error' : ''); ?>">
                                ...
                                <?php echo e(html()->text('offer_salary_min', $job->offer_salary_min)->class('form-control')->placeholder('Enter Offered Minimum Salary')); ?>
                        ...
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group <?php echo e($errors->has('offer_salary_max') ? ' has-error' : ''); ?>">
                                ...
                                <?php echo e(html()->text('offer_salary_max', $job->offer_salary_max)->class('form-control')->placeholder('Enter Offered Maximum Salary')); ?>
                        ...
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group <?php echo e($errors->has('salary_type') ? ' has-error' : ''); ?>">
                                ...
                                <?php echo e(html()->select('salary_type', ['Per hour' => 'Per hour', 'Per month' => 'Per month', 'Per annum' => 'Per annum'], $job->salary_type)->class('form-control')->placeholder('Salary Type')); ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group <?php echo e($errors->has('skills') ? ' has-error' : ''); ?>">
                                ...
                                <?php echo e(html()->select(
                                    'skills[]', 
                                    App\Models\Skill::whereIn('id', $job->skills->pluck('id'))->pluck('name', 'id'), 
                                    $job->skills->pluck('id')->toArray()
                                )->id('skills')->class('form-control')->multiple()); ?>
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group<?php echo e($errors->has('country') ? ' has-error' : ''); ?>">
                                ...
                                <?php echo e(html()->select('country', App\Models\Country::where('id', $job->country_id)->pluck('name', 'id'), $job->country_id)->class('form-control')->placeholder('Choose  Country')); ?>
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group<?php echo e($errors->has('state') ? ' has-error' : ''); ?>">
                                ...
                                <?php echo e(html()->select('state', App\Models\State::where('id', $job->state_id)->pluck('name', 'id'), $job->state_id)->class('form-control')->placeholder('State')); ?>
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group<?php echo e($errors->has('district') ? ' has-error' : ''); ?>">
                                ...
                                <?php echo e(html()->select('district', App\Models\District::where('id', $job->district_id)->pluck('name', 'id'), $job->district_id)->class('form-control')->placeholder('District')); ?>
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group<?php echo e($errors->has('city') ? ' has-error' : ''); ?>">
                                ...
                                <?php echo e(html()->select('city', App\Models\City::where('id', $job->city_id)->pluck('name', 'id'), $job->city_id)->class('form-control')->placeholder('City')); ?>
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group<?php echo e($errors->has('pincode') ? ' has-error' : ''); ?>">
                                ...
                                <?php echo e(html()->text('pincode', $job->pincode)->class('form-control')->placeholder('Pincode')); ?>
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group<?php echo e($errors->has('address') ? ' has-error' : ''); ?>">
                                ...
                                <?php echo e(html()->text('address', $job->address)->class('form-control')->placeholder('Address')); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group <?php echo e($errors->has('deadline') ? ' has-error' : ''); ?>">
                                ...
                                <?php echo e(html()->date('deadline', $job->deadline)->class('form-control')); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group<?php echo e($errors->has('status') ? ' has-error' : ''); ?>">
                                ...
                                <?php echo e(html()->select('status', App\Models\Status::whereIn('id', [14, 15])->pluck('name', 'id'), $job->status_id)->class('form-control')->placeholder('Choose Status')); ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group<?php echo e($errors->has('about_job') ? ' has-error' : ''); ?>">
                                ...
                                <?php echo e(html()->textarea('about_job', $job->description)->class('form-control')->placeholder('About Job')); ?>
...
<?php echo $__env->make('common.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/asifjamal/Documents/enabledtalent/resources/views/company/job/edit.blade.php ENDPATH**/ ?>