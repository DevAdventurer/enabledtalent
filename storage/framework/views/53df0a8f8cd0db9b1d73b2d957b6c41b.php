...
<?php echo $__env->make('admin.media.media-files', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php echo $__env->make('admin.layouts.shortcut', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<script src="<?php echo e(asset('admin-assets/js/crudAjax.js')); ?>"></script>
<script src="https://cdn.datatables.net/1.11.5/js/jquery.dataTables.min.js"></script>
<script src="https://cdn.datatables.net/1.11.5/js/dataTables.bootstrap5.min.js"></script>
<script src="https://cdn.datatables.net/responsive/2.2.9/js/dataTables.responsive.min.js"></script>
<script type='text/javascript' src='https://cdn.jsdelivr.net/npm/toastify-js'></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jscroll/2.4.1/jquery.jscroll.min.js"></script>
<script src="<?php echo e(asset('admin-assets/libs/glightbox/js/glightbox.min.js')); ?>"></script>
...
<script type="text/javascript">
        ...
        function updateData(url,data={},callback=null){  
            if (confirm('Are you sure to perform this action')){                      
                $.ajax({
                    url:url,
                    method: 'post',
                    data:Object.assign({'_method':'PUT','_token':'<?php echo e(csrf_token()); ?>'},data),
                    dataType:'json',
    ...
    </html><?php /**PATH /Users/mamoonnasar/Documents/enabledtalent/resources/views/admin/layouts/master.blade.php ENDPATH**/ ?>