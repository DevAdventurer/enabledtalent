    ...
    <div class="container">
        <div class="col-md-8 col-lg-7 col-xl-5 mx-auto">
            <div class="login-form">
                ...
                <?php echo e(html()->form('POST', route('candidate.registration.post'))->attribute('enctype', 'multipart/form-data')->id('storeForm')->open()); ?>
                ...
                <div class="login-footer">
                    ...
                    <p>Already have an account? <a href="<?php echo e(route('candidate.login.form')); ?>">Sign In.</a></p>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('common.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mamoonnasar/Documents/enabledtalent/resources/views/candidate/auth/registration.blade.php ENDPATH**/ ?>