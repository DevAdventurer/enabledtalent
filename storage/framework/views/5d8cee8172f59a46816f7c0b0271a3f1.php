    ...
    <div class="col-lg-4 col-sm-12 col-12 position-sticky">
        ...
        <div class="card">
            <div class="card-body" id="form">
             <?php echo e(html()->form('POST', route('admin.job-type.store'))->attribute('enctype', 'multipart/form-data')->id('storeForm')->open()); ?>
                    ...
                    <table id="dataTableAjax" class="display table-sm border-secondary dataTableAjax table table-striped table-bordered dom-jQuery-events" >
                        <thead>
                            <tr>
                                ...
                                <th>Name</th>
                                <th>Status</th>
                                <?php if (\Illuminate\Support\Facades\Blade::check('can', ['edit_skill','delete_skill'])): ?>
                                <th>Action</th>
                                <?php endif; ?>
            ...
            { "data": "status" }, 
            {
                ...
                render: function(data, type, row) {
                    if (type === 'display') {
                        ...
                        <?php if (\Illuminate\Support\Facades\Blade::check('can', 'edit_skill')): ?>
                        ...
                        <?php if (\Illuminate\Support\Facades\Blade::check('can', 'delete_skill')): ?>
                        btn += '<li><button type="button" onclick="deleteModel(\''+window.location.href+'/'+row['id']+'/delete\')" class="dropdown-item remove-item-btn"><i class="ri-delete-bin-fill align-bottom me-2 text-muted"></i> Delete</button></li>';
                        <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/asifjamal/Documents/enabledtalent/resources/views/admin/job-type/list.blade.php ENDPATH**/ ?>