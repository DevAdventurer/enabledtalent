...
<div id="section_{{$section->id}}" class="video-with-text-section">
	<div class="container">
	<div class="video-text-row py-80">
		...
		<div class="video-text-video-section">
			<div class="poster-image">
				@if(isset($content['title']))
					<img src="{{ asset($content['thumbnail_image']) }}">
				@endif
				<img src="{{ asset('assets/img/hero/video-controls-2.svg') }}" class="google-meeting">
			</div>
				<a onclick="openPopup('{{ $content['youtube_id'] }}')" href="javascript:voide(0)" class="play-button" 
			...
			{{-- <div class="poster-image poster-image-small">
				<img src="{{ asset('assets/img/video-thumbnail.jpg') }}">
			</div> --}}
		</div>
