    ...
    <div class="col-lg-4 col-sm-12 col-12 position-sticky">
        ...
        <div class="card">
            <div class="card-body" id="form">
             {{ html()->form('POST', route('admin.job-type.store'))->attribute('enctype', 'multipart/form-data')->id('storeForm')->open() }}
                ...
                {{ html()->button('Save Industry')->type('button')->class('btn btn-success store') }}
            {{ html()->form()->close() }}
        </div>
