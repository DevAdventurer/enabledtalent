...
Route::middleware('admin.auth')->group(function() {
    ...
    Route::post('dashboard', [DashboardController::class, 'filter'])->name('dashboard.filter')->middleware('can:browse_dashboard');
     ...
     Route::controller(CommonController::class)->name('common.')->group(function(){
        ...
        Route::get('common/page/item/add/{id}', 'pageItemAdd')->name('page.item.add');

        Route::get('common/page/generate/slug', 'generateSlug')->name('page.generate.slug');
    });
    ...
    Route::controller(PageController::class)->group(function(){
        Route::match(['get','patch'],'page', 'index')->name('page.index')->middleware('can:browse_page');
        Route::get('page/create', 'create')->name('page.create')->middleware('can:add_page');
        Route::get('page/{id}', 'show')->name('page.show')->middleware('can:read_page');
        Route::get('page/{id}/edit', 'edit')->name('page.edit')->middleware('can:edit_page');
        Route::post('page', 'store')->name('page.store')->middleware('can:add_page');
        Route::put('page/{id}', 'update')->name('page.update')->middleware('can:edit_page');
        Route::delete('page/{id}/delete', 'destroy')->name('page.destroy')->middleware('can:delete_page');

        //Route::get('page/section/add/{id}', 'sectionAdd')->name('page.section.add');
        Route::post('page/section/add/{id}', 'sectionStore')->name('page.section.store');
        Route::post('page/section/update/{id}', 'sectionUpdate')->name('page.section.update');
        Route::delete('page/section/{id}/delete', 'destroySection')->name('page.section.destroy')->middleware('can:delete_page');
    });


    //JobType
    Route::controller(JobTypeController::class)->group(function(){
        Route::match(['get','patch'],'job-type', 'index')->name('job-type.index')->middleware('can:browse_job_type');
        Route::get('job-type/create', 'create')->name('job-type.create')->middleware('can:add_job_type');
        Route::get('job-type/{id}', 'show')->name('job-type.show')->middleware('can:read_job_type');
        Route::get('job-type/{id}/edit', 'edit')->name('job-type.edit')->middleware('can:edit_job_type');
        Route::post('job-type', 'store')->name('job-type.store')->middleware('can:add_job_type');
        Route::put('job-type/{id}', 'update')->name('job-type.update')->middleware('can:edit_job_type');
        Route::delete('job-type/{id}/delete', 'destroy')->name('job-type.destroy')->middleware('can:delete_job_type');
    });


    //Skill
    Route::controller(SkillController::class)->group(function(){
        Route::match(['get','patch'],'skill', 'index')->name('skill.index')->middleware('can:browse_skill');
        Route::get('skill/create', 'create')->name('skill.create')->middleware('can:add_skill');
        Route::get('skill/{id}', 'show')->name('skill.show')->middleware('can:read_skill');
        Route::get('skill/{id}/edit', 'edit')->name('skill.edit')->middleware('can:edit_skill');
        Route::post('skill', 'store')->name('skill.store')->middleware('can:add_skill');
        Route::put('skill/{id}', 'update')->name('skill.update')->middleware('can:edit_skill');
        Route::delete('skill/{id}/delete', 'destroy')->name('skill.destroy')->middleware('can:delete_skill');
    });
